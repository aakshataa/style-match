"""STYLEMATCH MAIN MODULE

Module Description
==================
This module contains the user interface. Running this file will display StyleMatch.
...
class StyleMatch:
    ...
    Instance Attributes:
        - graph: The graph associated to the dataset
        - window: The window of the UI
        - items: The clothing items displayed in the UI
        - dataset: the filename of the dataset being used, of type .csv
        - widgets: lsit of widgets displayed on interface
